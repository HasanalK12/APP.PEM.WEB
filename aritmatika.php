...
<form name="kalkulator" method="post" action="aritmatika.php">
	<h2 class="brand">Operator Aritmatika By Hasan</h2>
	<table width="50%" border="1">
		<tr>
			
			<input type="text" name="operand1" class="bil" autocomplete="off" placeholder="Masukkan Bilangan Pertama">
			<input type="text" name="operand2" class="bil" autocomplete="off" placeholder="Masukkan Bilangan Kedua">
	</tr>
